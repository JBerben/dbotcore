...
import org.darkstorm.bcel.transformers.TestTransformer;
...
public class OldSchoolLoader implements Loader, AppletStub, AppletContext {
	...
	public void load(Cache cache, Status status) throws IOException {
		...
		if(!cache.isCached("euclid_pairs")) {
			...
			Map<String, EuclideanNumberPair> pairs = numberDeobber
					.getFinalPairs();
			...
			Map<String, EuclideanNumberPair> pairs = new HashMap<String, EuclideanNumberPair>();
	...
	public static void main(String[] args) throws ClassNotFoundException,
			IOException {
		Class.forName(DarkBotRS.class.getName());
